...
const Sidebar = () => {
  ...
  return (
    <aside className={`
      bg-custom-dark-2 z-50 transition-all duration-300
      ...
      md:w-20
      border-b md:border-r md:border border-white/10
      md:rounded-full
    `}>
